...
Still, a plethora of issues must still be addressed, questions must be answered and math must be solved. % Look at this again
\\ % Newline
...
\end{multicols}
    \begin{figure}[H]
        \maxsizebox{\textwidth}{\textheight}{\includegraphics[width=\textwidth, height=\textheight, keepaspectratio]{first/raw/neutron_rad.jpg}}
...
\end{multicols}
    \begin{figure}[H]
        \noindent\makebox[\textwidth]{
            \maxsizebox{\textwidth}{\textheight}{\includegraphics[width=\textwidth, height=\textheight, keepaspectratio]{first/raw/radiation.png}}
        }
...
\end{multicols}
\begin{figure}[H]
    \maxsizebox{\textwidth}{\textheight}{\includegraphics[scale=0.5, width=\textwidth, height=\textheight, keepaspectratio]{first/raw/waterice.png}}
...
\end{multicols}
\begin{figure}[H]
    \maxsizebox{\textwidth}{\textheight}{\includegraphics[scale=0.5, width=\textwidth, height=\textheight, keepaspectratio]{first/raw/topography.jpg}}
...
\begin{figure}[H]
    \maxsizebox{\textwidth}{\textheight}{\includegraphics[width=\textwidth, height=\textheight, keepaspectratio, height=\textheight, keepaspectratio]{first/out/out.first.downscaled.png}}
...
Unfortunately, this pixel count is too low to get a good result.
Due to this, the topography map was removed.
This map required all maps to be at the elevation at which their values were at, which does not produce good results.

\begin{figure}[H]
    \maxsizebox{\textwidth}{\textheight}{\includegraphics[scale=0.5, width=\textwidth, height=\textheight, keepaspectratio]{first/out/out.first.downscaled.without_topo.png}}
...
\end{enumerate}
All of those spots are visualized below
\begin{figure}[H]
    \maxsizebox{\textwidth}{\textheight}{\includegraphics[scale=0.5, width=\textwidth, height=\textheight, keepaspectratio]{first/out/locos.png}}
    \captionsource{Locations that may be considered landing spots}{NASA/JPL}
    \label{fig:tempend}
\end{figure}
...
\begin{figure}[H]
    \maxsizebox{\textwidth}{\textheight}{\includegraphics[scale=0.5, width=\textwidth, height=\textheight, keepaspectratio]{second/raw//daytime.jpg}}
    \captionsource{Temperature by day on Mars}{NASA/JPL}
    \label{fig:tempbyday}
\end{figure}

\begin{figure}[H]
    \maxsizebox{\textwidth}{\textheight}{\includegraphics[scale=0.5, width=\textwidth, height=\textheight, keepaspectratio]{second/raw/nighttime.jpg}}
...
\begin{figure}[H]
    \maxsizebox{\textwidth}{\textheight}{\includegraphics[scale=0.5, width=\textwidth, height=\textheight, keepaspectratio]{second/out/out.second.downscaled.png}}
...
\begin{figure}[H]
    \maxsizebox{\textwidth}{\textheight}{\includegraphics[scale=0.5, width=\textwidth, height=\textheight, keepaspectratio]{first/out/final.png}}
